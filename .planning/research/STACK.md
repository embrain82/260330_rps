...
**Domain:** HTML5 mobile-first mini-game (가위바위보 — rock-paper-scissors), embeddable, event/promotion context
**Researched:** 2026-03-30
**Confidence:** HIGH (core stack verified via official sources and current npm metadata)
...
> Note: `create-next-app` at current version bootstraps Next.js 15 + React 19 + Tailwind v4. Verify output confirms these major versions before proceeding.
...
**If embedding as an iframe in an external service:**
...
**If embedding as a React component in an existing Next.js app:**
...
**If deploying as a standalone Vercel project:**
...
*Stack research for: HTML5 가위바위보 미니게임 (RPS Challenge)*
*Researched: 2026-03-30*
